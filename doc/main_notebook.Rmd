...
candidate_table["right","Detected_errors"] <- total_corrected
candidate_table["right","Actual_errors"] <- total_act_corrected
candidate_table["wrong","Detected_errors"] <- 
  detected_denom - total_corrected - candidate_table["no_candidate","Detected_errors"]
candidate_table["wrong","Actual_errors"] <- 
  act_denom - total_act_corrected - candidate_table["no_candidate","Actual_errors"]
candidate_table
```
...
Digging into the slight drop of character-level precision and recall, we also create a plot showing the ratio of letter frequencies in the original tesseract to those in the ground truth.
