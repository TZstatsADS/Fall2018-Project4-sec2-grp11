...
# source('../lib/features.R')
system.time(train_input <-matrix(unlist(lapply(train_tokens,extract_feature, bigrams_all)), byrow = TRUE, nrow = length(train_tokens)))
...
system.time(test_input <- matrix(unlist(lapply(test_tokens,extract_feature,bigrams_all)), byrow = TRUE, nrow = length(test_tokens)))
...
potential cause 1: training vocabulary limited
suggestion: enlarge training dictionaries
