...
# library(e1071)
library(kernlab)
system.time(fit_svm <- ksvm(x = train_input_na, y = train_labels, type = "nu-svc", nu = 0.05, cross=3))
system.time(fit_svm <- ksvm(x = train_input_na, y = train_labels, type = "nu-svc", nu = 0.5, cross=3))
system.time(fit_svm <- ksvm(x = train_input_na, y = train_labels, type = "nu-svc", nu = 0.9, cross=3))
```
